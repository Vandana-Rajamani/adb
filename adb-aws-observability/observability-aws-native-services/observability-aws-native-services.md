...
1. Select a metric to create an alarm for (e.g., **CPUUtilization**).
   ...
   Perform Steps 1 to 5 in [Task 1](?lab=observability-aws-native-services#Task1:ExploreDatabaseMetricsinAWSCloudWatch) above and then click on the **Create alarm** button.
